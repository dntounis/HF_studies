...
# Plot the histogram for each radius
plt.style.use(hep.style.ATLAS)  # Use ATLAS style from mplhep


plt.figure(figsize=(10, 6))
plt.hist(r_phi_dist_at_radius_array, bins=50, alpha=0.6, label=f'xy Distance at r={radius_to_project} mm')
plt.xlabel('xy Distance [mm]')
plt.ylabel('Number of Tracks')
plt.title('Distance between Highest Momentum Track and Others')
plt.savefig("r_phi_distance_distribution_v3.png")
plt.show()


# plot dijet invariant mass
plt.figure(figsize=(10, 6))
plt.hist(dijet_mass_array, bins=50, alpha=0.6, label=f'Dijet Invariant Mass')
...
## Now, plot the histogram for each radius

#plt.xlabel('r-phi Distance')
#plt.ylabel('Number of Tracks')
#plt.legend(title="Radii")
#plt.title("r-phi Distance between Highest Momentum Track and Others")
#plt.savefig("r_phi_distance_distribution_v3.png")
#plt.show()
